...
export async function fetchPicture(name,page) {
    const arrPicture = await fetch(`https://pixabay.com/api/?key=23818596-d5461ac6688865132aed17576&q=${name}&image_type=photo&orientation=horizontal&safesearch =true&page=${page}&per_page=40`)
